...
Standardizer::Standardizer(treeNode* topNode) {
...
void Standardizer::standardizeLET(treeNode* topNode){
    treeNode* p;
...
void Standardizer::standardizeWHERE(treeNode* topNode){
    treeNode* p, *x, *e;
...
void Standardizer::standardizeWITHIN(treeNode* topNode){
    treeNode *x1, *x2, *e1;
...
void Standardizer::standardizeREC(treeNode* topNode){
    treeNode *x, *e, *temp;
...
void Standardizer::standardizeFCNFORM(treeNode* topNode){
...
void Standardizer::standardizeLAMBDA(treeNode* topNode){
    treeNode *temp, *newNode;
...
void Standardizer::standardizeAND(treeNode* topNode){
    treeNode* temp;
...
void Standardizer::standardizeAT(treeNode* topNode){
    treeNode* E1, *N, *E2;
...
void Standardizer::standardize(treeNode* topNode){
